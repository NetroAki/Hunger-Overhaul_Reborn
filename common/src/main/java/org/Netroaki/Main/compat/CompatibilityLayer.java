...
public class CompatibilityLayer {
    ...
    private static void initialize1_20_1() {
        HOReborn.LOGGER.info("[CompatibilityLayer] Using 1.20.1 specific implementations");
    ...
    private static void initialize1_21_1() {
        HOReborn.LOGGER.info("[CompatibilityLayer] Using 1.21.1 specific implementations");
    ...
    private static boolean shouldCropGrow_1_20_1(Object level, Object pos, Object state) {
        ...
        try {
            ...
            HOReborn.LOGGER.error("[CompatibilityLayer] Error calling SereneSeasonsAPI for 1.20.1", e);
            return false;
        }
    }
    ...
    private static boolean shouldCropGrow_1_21_1(Object level, Object pos, Object state) {
        ...
        try {
            ...
            HOReborn.LOGGER.error("[CompatibilityLayer] Error calling SereneSeasonsAPI for 1.21.1", e);
            return false;
        }
    }
