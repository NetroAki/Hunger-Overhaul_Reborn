...
public abstract class FoodEvent {
     ...
     * unmodifiedFoodValues contains the food values of the food before the GetFoodValues event was fired.
    ...
    /**
     * Fired after food is eaten, containing the effects and context for the food that was eaten.
     *
