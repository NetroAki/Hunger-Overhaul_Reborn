...
/**
 * Utility class for automatic food categorization based on item names and patterns.
 * Provides both simple pattern matching and more sophisticated heuristic-based categorization.
 */
public class FoodCategorizer {
     ...
     * Handles complexity assessment, ingredient inference, and cooking method detection.
     */
    ...
    /**
     * Determine if an item is a processed single ingredient (butter, sauce, powder, etc).
     */
    ...
    /**
     * Determine if an item is a LIGHT_MEAL (simple prepared items, 2-3 ingredients).
     */
    ...
    /**
     * Determine if an item is an AVERAGE_MEAL (4-5 ingredients, complex preparation).
     */
    ...
    /**
     * Determine if an item is a LARGE_MEAL (6+ ingredients, very complex preparation).
     */
